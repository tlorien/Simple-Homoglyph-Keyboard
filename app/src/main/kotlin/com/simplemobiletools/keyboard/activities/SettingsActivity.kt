...
<<<<<<< HEAD
    private fun setupHomoglyphicsToggle() {
        binding.settingsHomoglyphics.apply {
            isChecked = config.homoglyphicsEnabled
            setOnCheckedChangeListener { buttonView, isChecked ->
                if (buttonView.isPressed) {
                    config.homoglyphicsEnabled = isChecked
                }
            }
        }
    }
...
<<<<<<< HEAD
            ...
            settingsPurchaseThankYouHolder.setOnClickListener(null)
=======
